...
namespace WebApi.Controllers
{
    public class ClienteController : ApiController
    {
        ...
        {
            instanciaCliente = new InstanciaCliente();
        }
        ...
        public IHttpActionResult Get(string cpf)
        {
            try
            {
                var result = instanciaCliente._clienteService.BuscarCPF(cpf);
                if (result == null)
                {
        ...
        public IHttpActionResult Post([FromBody] Cliente cliente)
        {
            ...
            try
            {
                bool result = instanciaCliente._clienteService.Cadastrar(cliente, cliente.CPF);
                if (result)
                {
                    return Ok();
                }
